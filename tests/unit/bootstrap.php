...
define( 'QEM_FILE', ABSPATH . 'quick-events-manager.php' );
define( 'QEM_PATH', ABSPATH );
define( 'QEM_URL', 'https://example.test/wp-content/plugins/quick-events-manager/' );
define( 'QEM_BASENAME', 'quick-events-manager/quick-events-manager.php' );
